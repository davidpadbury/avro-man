var fs = require('fs'), a = require('../lib/avroMan'), path = require('path');
...
var schema = JSON.parse(fs.readFileSync(path.join(__dirname, './search.avsc'), 'utf8'));
...
var profile_created_schema = JSON.parse(fs.readFileSync(path.join(__dirname, './ProfileCreate.avsc'), 'utf8'));
...
var inventory_schema = JSON.parse(fs.readFileSync(path.join(__dirname, './Inventory.avsc'), 'utf8'));
...
var producttype_get_schema = JSON.parse(fs.readFileSync(path.join(__dirname, './get'), 'utf8'));

var get = {"locale": {"language": "EN", "country": "US"}};

a.encode(producttype_get_schema, get);

var producttype_get_succeeded_schema = JSON.parse(fs.readFileSync(path.join(__dirname, './getSucceeded.avsc'), 'utf8'));

var get_succeeded = fs.readFileSync(path.join(__dirname, './getSucceeded.bin'), 'binary');
